...
npx testlight run examples/intermediate/07_simple_suite/suite_parallel.mmt

# Run tests sequentially
npx testlight run examples/intermediate/07_simple_suite/suite_sequential.mmt
```
