...
```sh
npx testlight run examples/intermediate/06_imports/test_relative.mmt --env-file examples/intermediate/06_imports/multimeter.mmt
```

Run using project root import:

```sh
npx testlight run examples/intermediate/06_imports/test_root_import.mmt --env-file examples/intermediate/06_imports/multimeter.mmt
```

Run the inner API test directly:

```sh
npx testlight run examples/intermediate/06_imports/tests/test_api.mmt --env-file examples/intermediate/06_imports/multimeter.mmt
```
...
- See [Simple Test](../../basic/02_simple_test/) for a direct basic test example.
- See [CSV Data Driven Test](../09_csv_data_driven_test/) for CSV data imports.
- See [Environment Presets](../10_environment_presets/) for environment presets in `multimeter.mmt`.
