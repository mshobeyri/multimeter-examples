...
```sh
npx testlight run examples/intermediate/11_control_flow/if_else_test.mmt
npx testlight run examples/intermediate/11_control_flow/repeat_delay_test.mmt
npx testlight run examples/intermediate/11_control_flow/for_loop_test.mmt
```
