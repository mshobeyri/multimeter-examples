...
```sh
npx testlight run examples/intermediate/18_simple_mock_server/test/health_test.mmt
npx testlight run examples/intermediate/18_simple_mock_server/test/user_test.mmt
npx testlight run examples/intermediate/18_simple_mock_server/test/search_test.mmt
```

Run the full suite:

```sh
npx testlight run examples/intermediate/18_simple_mock_server/suite.mmt
```

Override inputs:

```sh
npx testlight run examples/intermediate/18_simple_mock_server/test/user_test.mmt -e user_id=99
```
