...
```sh
npx testlight run examples/19_report_generation/suite.mmt
```
...
```sh
# JUnit XML
npx testlight run examples/19_report_generation/suite.mmt --report junit

# HTML
npx testlight run examples/19_report_generation/suite.mmt --report html

# Markdown
npx testlight run examples/19_report_generation/suite.mmt --report md

# MMT YAML
npx testlight run examples/19_report_generation/suite.mmt --report mmt
```
...
```sh
npx testlight run examples/19_report_generation/test/pass_test.mmt --report junit
```
